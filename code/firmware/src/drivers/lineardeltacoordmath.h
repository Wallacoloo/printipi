...
#ifndef DRIVERS_LINEARDELTACOORDMATH_H
#define DRIVERS_LINEARDELTACOORDMATH_H

#include "coordmath.h"

namespace drv {

template <std::size_t AIdx, std::size_t BIdx, std::size_t CIdx, std::size_t EIdx, unsigned R1000, unsigned L1000> class LinearDeltaCoordMath : public CoordMath {
	public:
